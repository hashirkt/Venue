                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            icon: showPass == true
                                ? Icon(Icons.visibility_off,color: btnColor.withOpacity(0.5))
                                : Icon(Icons.visibility,color: btnColor,),
                          ),
                        ),
                      ),
                      SizedBox(
                      ...
                      InkWell(
                        onTap: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            if(usernameController.text=="admin@gmail.com" && passwordController.text=="123456789"){
                            ...
                            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>AdminHomePage()), (route) => false);
                            ...
                            else
                              {
                                ...
                                then((user) => FirebaseFirestore.instance.collection('user').doc(user.user!.uid).get().then((value) {
                                  ...
                                  if(value.data()!['usertype']=='auditorium') {
                                    ...
                                    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>AudHomePage(

                                        email:value.data()!['email'],
                                        audname:value.data()!['audname'],
                                        phoneno:value.data()!['phoneno'],
                                        place:value.data()!['place'],
                                        pin:value.data()!['pin'],
                                        id:value.data()!['id'],
                                      imgurl: value.data()!['img'],
                                    facility: value.data()!['facilities'],
                                  ...
                                  if(value.data()!['usertype']=='event') {
                                    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>EventHomePage(
