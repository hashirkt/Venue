                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: ListTile(
                                          ...
                                          content: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(height: 10,),
                                                AppText(text: snapshot.data!.docs[index]['customername'],size: 18,),
                                                AppText(text: snapshot.data!.docs[index]['customeremail'],size: 16,),
                                                AppText(text:snapshot.data!.docs[index]['amount'],size: 16,),
                                                ...
                                                snapshot.data!.docs[index]['status']==0?  InkWell(
                                                  onTap: (){
                                                    ...
                                                    FirebaseFirestore.instance.collection('payment').doc(snapshot.data!.docs[index]['paymentid']).update({
                                  ...
                                  subtitle: AppText(text:"Rs.${snapshot.data!.docs[index]['amount']}/-",size: 16,),
                                ),
                              ),
                            ),
                          );
