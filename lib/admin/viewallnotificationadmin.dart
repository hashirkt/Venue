...
class ViewAllNotificationsAdmin extends StatefulWidget {
  String?uid;
  ViewAllNotificationsAdmin({Key? key,this.uid}) : super(key: key);

  @override
  State<ViewAllNotificationsAdmin> createState() => _ViewAllNotificationsAdminState();
}

class _ViewAllNotificationsAdminState extends State<ViewAllNotificationsAdmin> {
  @override
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            notification[index]['status']==1?      AppText(text: "Active",size: 16,fw: FontWeight.w700,color: Colors.green,):AppText(text: "Expired",size: 16,fw: FontWeight.w700,color: Colors.red,),
