...
class AuditoriumRegistration  extends StatefulWidget {
  const AuditoriumRegistration({Key? key}) : super(key: key);

  @override
  State<AuditoriumRegistration> createState() => _AuditoriumRegistrationState();
}

class _AuditoriumRegistrationState extends State<AuditoriumRegistration > {
  bool showPass=true;
  bool showPass1=true;
                    ...
                    if (_formKey.currentState!.validate()) {
                      FirebaseAuth.instance
                        ...
                        FirebaseFirestore.instance
                          ...
                          'audname': audnameController.text,
