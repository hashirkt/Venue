...
class ViewAllNotificationsAud extends StatefulWidget {
  String?uid;
  ViewAllNotificationsAud({Key? key,this.uid}) : super(key: key);

  @override
  State<ViewAllNotificationsAud> createState() => _ViewAllNotificationsAudState();
}

class _ViewAllNotificationsAudState extends State<ViewAllNotificationsAud> {
  @override
            ...
            children: [
              ...
              Container(
                  ...
                  child:StreamBuilder<QuerySnapshot>(
                    ...
                    stream: FirebaseFirestore.instance.collection('notification').where('category',isEqualTo: 'Auditorium').where('status',isEqualTo: 1).snapshots(),
