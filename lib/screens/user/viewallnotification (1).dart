...
class ViewAllNotificationsUSer extends StatefulWidget {
  String?uid;
  ViewAllNotificationsUSer({Key? key,this.uid}) : super(key: key);

  @override
  State<ViewAllNotificationsUSer> createState() => _ViewAllNotificationsUSerState();
}

class _ViewAllNotificationsUSerState extends State<ViewAllNotificationsUSer> {
  @override
